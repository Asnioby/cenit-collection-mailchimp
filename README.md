This is a new Shared Collection (integration settgings) to be use in Cenit, named cenit-collection-mailchimp.

Cenit is an open source social platform as a service for data and business integration.

# CenitCollectionMailchimp
...
```ruby
gem 'cenit-collection-mailchimp'
```
...
Or install it yourself as:
    ...
    $ gem install cenit-collection-mailchimp
...
% tree
.
├── cenit-collection-cenit-collection-mailchimp.gemspec
├── Gemfile
├── .gitignore
├── .rspec
├── README.md
    ...
    └── cenit
        └── collection
            └── cenit-collection-mailchimp
                 ...
                 └── build.rb
                 └── version.rb
            └── cenit-collection-mailchimp.rb
└── spec
    └── cenit
        └── collection
            └── cenit-collection-mailchimp_spec.rb
    └── spec_helper.rb
    └── support
        └── samples
```
...
1. Fork it ( https://github.com/[my-github-username]/cenit-collection-mailchimp/fork )
